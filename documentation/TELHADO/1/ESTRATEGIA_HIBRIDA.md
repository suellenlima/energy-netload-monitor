...
```python
from backend.src.services.imagem_strategy_service import ImagemStrategyService
...
# Modificar em imagem_strategy_service.py, linha ~125:
...
2. **[backend/src/services/imagem_strategy_service.py](backend/src/services/imagem_strategy_service.py)**
