...
### 1. Novo Serviço: `CBERSService`

**Arquivo:** `backend/src/services/cbers_service.py`
...
class CBERSService:
    ...
    def buscar_imagens(lat, lon, raio_km, data_inicio, data_fim):
        """Busca imagens CBERS-4A via STAC"""
        
    def download_banda(image_id, banda):
        """Download de banda individual (pan, red, green, blue, nir)"""
