...
from ..repositories.telhado_multifonte_repository import TelhadoMultiFonteRepository
...
class TelhadoMultiFonteService:
    ...
    def _tentar_google_maps(
        ...
        """
        try:
            from ..services.google_maps_service import GoogleMapsQuotaService
            from ..services.roof_service import TelhadoSegmentationService
            ...
            # Usar TelhadoSegmentationService para detectar
            servico_segmentacao = TelhadoSegmentationService(use_gpu=True)
            resultado_deteccao = servico_segmentacao.processar_telhados_lote(
                url_imagem=url,
