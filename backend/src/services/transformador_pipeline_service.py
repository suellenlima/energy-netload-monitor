...
Workflow:
  ...
  3. Para cada imagem:
     ...
     - Detecta telhados (TelhadoSegmentationService)
...
from ..repositories.transformador_pipeline_repository import TransformadorPipelineRepository
from .roof_service import TelhadoSegmentationService
...
class TransformadorPipelineService:
    ...
    def __init__(self, engine):
        ...
        self._servico_telhados: Optional[TelhadoSegmentationService] = None
    ...
    def _obter_servico_telhados(self) -> TelhadoSegmentationService:
        """Obtém ou cria instância do serviço de telhados."""
        if self._servico_telhados is None:
            self.logger.info("🔧 Inicializando serviço de segmentação de telhados...")
            self._servico_telhados = TelhadoSegmentationService()
