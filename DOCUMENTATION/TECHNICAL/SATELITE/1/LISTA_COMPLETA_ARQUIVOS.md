...
### Backend - Serviços
```
✨ backend/src/services/inpe_service.py (UNIFICADO)
   - Classes: INPEService (main), BoundingBox, SatelliteMetadata, ImagemCBERS
   - Métodos: 14 públicos + utilitários privados
   - Consolidação: 3 arquivos antigos (inpe_satellite_service.py + inpe_service_v2.py + cbers_service.py)
   - Linhas: 700+
   - Status: ✅ Production-ready
   - Aliases: INPESatelliteService, INPEServiceV2, CBERSService (retrocompatibilidade)
```
