...
```python
from backend.src.services.inpe_service import INPEService
...
imagens = service.buscar_cbers4a_coordenadas(
    latitude=-15.7939,
    longitude=-47.8828,
    raio_km=10.0,
...
- **Código-fonte:** `backend/src/services/inpe_service.py` (UNIFICADO)
